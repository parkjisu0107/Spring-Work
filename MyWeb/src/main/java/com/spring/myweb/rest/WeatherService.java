...
public class WeatherService {
	...
	public void getShortTermForecast(String area1, String area2) {
		...
		try {			
		    ...
		    urlBuilder.append("?" + URLEncoder.encode("serviceKey","UTF-8") + "=bTF%2FAdnC3BgkNx43s7PUuEnqp%2BdsQlUgugoFMKjtJm%2BukigORtMgK0D575uNuCEG8a%2F1%2B7hUtvYg5ylae8pqjQ%3D%3D"); /*Service Key*/
...
//		    System.out.println(sb.toString());
		    ...
		    for(Object obj : itemArray) {
		    	...
		    	if(category.equals("TMX") || category.equals("TMN")) {
		    		log.info("category: {}, fcsValue: {}", category, fcstValue);
		    	}
		    }
